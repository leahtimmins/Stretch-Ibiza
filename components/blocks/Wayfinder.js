...
const Wayfinder = ({blok, position}) => {
    ...
    return (
        <section className={`overflow-hidden ${sectionPadding === 'none' ? "py-0" : sectionPadding === 'small' ? "py-4 sm:py-8 md:py-12" : "py-12 smpy-24 md:py-32"} ${background}`} id={_uid} data-name={component}>
            <Container>
